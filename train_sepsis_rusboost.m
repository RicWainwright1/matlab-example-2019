...
% aggregate the data files and process
train_dir = '../data/training/';
sepsis = prepare_data(train_dir);

% save the data so we don't have to re prepare it every time
save sepsis_data.mat sepsis

% get the targets and variables
Y = sepsis(:,end);
sepsis(:,end) = [];
...
% save the trained rus model
save rus_model.mat rus_model
